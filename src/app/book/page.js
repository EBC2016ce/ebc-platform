...
export default function BookPage() {
  ...
  if (!customerId) {
    return (
      <main className="min-h-screen flex items-center justify-center px-6 py-16">
        <p className="text-[#A23B2E]">Missing customer reference. Please use the link from your verification email.</p>
      </main>
    )
  }
  ...
  if (!days) {
    return (
      <main className="min-h-screen flex items-center justify-center px-6 py-16">
        <p className="text-[#5A5E66]">Loading available times...</p>
      </main>
    )
  }
