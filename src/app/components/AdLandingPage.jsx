    ...
    <main className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-[#EAE7E0] shadow-sm">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between gap-4">
          ...
          <a href="tel:1300715840" className="inline-flex items-center gap-2 bg-[#0068D8] text-white text-sm font-semibold rounded-full px-5 py-2.5 hover:bg-[#0050B0] transition whitespace-nowrap">
